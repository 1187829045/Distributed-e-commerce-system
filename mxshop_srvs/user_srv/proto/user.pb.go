...
type CheckResponse struct {
	...
	Success bool `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"` // 密码检查是否成功
}
...
type UserListResponse struct {
	...
	Total int32               `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` // 总用户数
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    // 用户信息列表
}
