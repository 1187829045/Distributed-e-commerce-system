...
// Validate checks the field values on UserListResonse with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *UserListResonse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserListResonse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UserListResonseMultiError, or nil if none found.
func (m *UserListResonse) ValidateAll() error {
	return m.validate(true)
}

func (m *UserListResonse) validate(all bool) error {
	if m == nil {
		return nil
	}
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, UserListResonseValidationError{
			...
			if err := v.Validate(); err != nil {
				return UserListResonseValidationError{
					field:  fmt.Sprintf("Data[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return UserListResonseMultiError(errors)
	}

	return nil
}

// UserListResonseMultiError is an error wrapping multiple validation errors
// returned by UserListResonse.ValidateAll() if the designated constraints
// aren't met.
type UserListResonseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserListResonseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserListResonseMultiError) AllErrors() []error { return m }

// UserListResonseValidationError is the validation error returned by
// UserListResonse.Validate if the designated constraints aren't met.
type UserListResonseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserListResonseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserListResonseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserListResonseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserListResonseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserListResonseValidationError) ErrorName() string { return "UserListResonseValidationError" }

// Error satisfies the builtin error interface
func (e UserListResonseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUserListResonse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UserListResonseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UserListResonseValidationError{}
